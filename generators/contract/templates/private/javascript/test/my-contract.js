...
describe('<%= assetPascalCase %>Contract', () => {
    ...
    describe('#create<%= assetPascalCase %>', () => {
        ...
        it('should throw an error for a private asset that already exists', async () => {
            await contract.create<%= assetPascalCase %>(ctx, '001').should.be.rejectedWith('The private asset <%= assetSpaceSeparator %> 001 already exists');
        });
    ...
    describe('#read<%= assetPascalCase %>', () => {
        ...
        it('should throw an error for my private asset that does not exist', async () => {
            await contract.read<%= assetPascalCase %>(ctx, '003').should.be.rejectedWith('The private asset <%= assetSpaceSeparator %> 003 does not exist');
        });
    ...
    describe('#update<%= assetPascalCase %>', () => {
        ...
        it('should throw an error for my private asset that does not exist', async () => {
            await contract.update<%= assetPascalCase %>(ctx, '003').should.be.rejectedWith('The private asset <%= assetSpaceSeparator %> 003 does not exist');
        });
    ...
    describe('#delete<%= assetPascalCase %>', () => {
        ...
        it('should throw an error for my private asset that does not exist', async () => {
            await contract.delete<%= assetPascalCase %>(ctx, '003').should.be.rejectedWith('The private asset <%= assetSpaceSeparator %> 003 does not exist');
        });
